...
public class IntelSmithWaterman implements SWAlignerNativeBinding {
    ...
    */
    ...
    public void initialize(SWAlignerNativeArguments args) {
        if(args == null)
        {
                args = new SWAlignerNativeArguments(SWAlignerNativeArguments.OverhangStrategy.SOFTCLIP,1,-1,1,1);
        }
        else {
    ...
    public int w_open;
    public SWAlignerNativeArguments.OverhangStrategy strategy;
    ...
    public static int getStrategy(SWAlignerNativeArguments.OverhangStrategy strategy)
    {
        int intStrategy=0;
